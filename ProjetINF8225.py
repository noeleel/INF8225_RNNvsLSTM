...
from modelGRU import SimpleGRU, DoubleGRU, MultiGRU, DropoutGRU, BiGRU, ComplexGRU
...
with open('Resultats.txt', 'w') as f:
    with redirect_stdout(f):
       ...
       # List_model = [DropoutGRU(EMBEDDING_DIM, HIDDEN_DIM,len(word_to_ix),  len(tag_to_ix), DROPOUT)]
        List_model = [DoubleGRU(EMBEDDING_DIM, HIDDEN_DIM,len(word_to_ix),  len(tag_to_ix))]
